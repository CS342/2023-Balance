...
public struct ScheduleView: View {
    @EnvironmentObject var scheduler: BalanceScheduler
                ...
                BalanceScheduler(
                    tasks: [
                        Task(
                            ...
                            context: BalanceTaskContext.questionnaire(Bundle.main.questionnaire(withName: "SocialSupportQuestionnaire"))
                        )
                    ]
                )
            )
